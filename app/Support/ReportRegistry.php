    ...
    public static function all(): array
    {
        return [
            ...
            'jenis-po' => [
                ...
                'filters' => ['date_range', 'jenis_po', 'brand'],
                'columns' => [
            ...
            'monitoring-deadline' => [
                ...
                'columns' => [
                    ...
                    ['key' => 'brand_nama', 'label' => 'Brand'],
                    ['key' => 'pelanggan', 'label' => 'Pelanggan'],
                    ['key' => 'paket_order', 'label' => 'Paket Order'],
                    ['key' => 'pcs', 'label' => 'PCS', 'format' => 'number'],
            ...
            'kinerja-produksi' => [
                ...
                'columns' => [
                    ...
                    ['key' => 'tanggal_masuk', 'label' => 'Tgl Masuk', 'format' => 'date'],
                    ['key' => 'deadline_produksi', 'label' => 'Deadline Produksi', 'format' => 'date'],
                    ['key' => 'keterlambatan_produksi', 'label' => 'Ket. Produksi'],
                    ['key' => 'deadline_customer', 'label' => 'Deadline Customer', 'format' => 'date'],
                    ['key' => 'keterlambatan_customer', 'label' => 'Ket. PO Admin'],
                    ['key' => 'pcs', 'label' => 'PCS', 'format' => 'number'],
                    ['key' => 'status', 'label' => 'Status PO', 'format' => 'status_badge'],
