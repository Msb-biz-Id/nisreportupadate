    ...
    public static function all(): array
    {
        return [
            ...
            'wilayah' => [
                ...
                'icon' => 'MapPin',
                'group' => 'penjualan',
                'description' => 'Distribusi order per wilayah (provinsi & kabupaten).',
                'filters' => ['date_range'],
                'columns' => [
            ...
            'rijek' => [
                ...
                'icon' => 'AlertTriangle',
                'group' => 'produksi',
                'description' => 'Detail rijek produksi: jenis, tingkat, biaya ganti.',
                'filters' => ['date_range'],
                'columns' => [
                    ['key' => 'no_po', 'label' => 'No PO'],
                    ...
                    ['key' => 'biaya_ganti', 'label' => 'Biaya Ganti', 'format' => 'currency'],
            ...
            'laba-rugi' => [
                ...
                'icon' => 'TrendingUp',
                'group' => 'keuangan',
                'description' => 'Ringkasan pemasukan vs pengeluaran per bulan.',
                'filters' => ['date_range'],
                'columns' => [
                    ['key' => 'bulan', 'label' => 'Bulan'],
                    ['key' => 'pemasukan', 'label' => 'Total Pemasukan', 'format' => 'currency'],
                    ['key' => 'pengeluaran', 'label' => 'Total Pengeluaran', 'format' => 'currency'],
                    ['key' => 'laba_rugi', 'label' => 'Laba/Rugi', 'format' => 'currency'],
                ],
                'chart' => ['type' => 'line', 'x' => 'bulan', 'y' => 'laba_rugi', 'title' => 'Tren Laba Rugi'],
            ],
            'peak-hours' => [
                'slug' => 'peak-hours',
                'label' => 'Peak Hours',
                'icon' => 'Clock',
                'group' => 'analitik',
                'description' => 'Heatmap jam tersibuk input order per hari dalam seminggu.',
                'filters' => ['date_range'],
                'columns' => [
                    ['key' => 'hari', 'label' => 'Hari'],
                    ['key' => 'jam', 'label' => 'Jam'],
                    ['key' => 'total', 'label' => 'Jumlah Order', 'format' => 'number'],
                ],
                'chart' => ['type' => 'heatmap', 'title' => 'Heatmap Jam Order Masuk'],
            ],
        ];
    }
