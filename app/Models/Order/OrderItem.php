...
class OrderItem extends Model
{
    ...
    public function jenisSetelan(): BelongsTo
    {
    ...
    {
        return $this->belongsTo(BahanKain::class);
    }
    public function bahanKainBawahan(): BelongsTo
    {
        return $this->belongsTo(BahanKain::class, 'bahan_kain_bawahan_id');
    }
    ...
    public function resleting(): BelongsTo
    {
        return $this->belongsTo(Resleting::class);
    }
    public function polaJahitan(): BelongsTo
    {
        return $this->belongsTo(PolaJahitan::class, 'pola_jahitan_id');
    }
    public function polaJahitanLengan(): BelongsTo
    {
        return $this->belongsTo(PolaJahitan::class, 'pola_jahitan_lengan_id');
    }
    public function namesets(): HasMany
    {
        return $this->hasMany(OrderNameset::class)->orderBy('urutan');
    }

    public function getBahanFormattedAttribute(): ?string
    {
        $ids = [];
        if ($this->bahan_kain_id) {
            $ids[] = $this->bahan_kain_id;
        }
        if (is_array($this->bahan_kain_ids)) {
            $ids = array_merge($ids, $this->bahan_kain_ids);
        }
