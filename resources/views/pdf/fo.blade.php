                    ...
                    <table class="spec-table" style="margin-top:0;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @foreach($chunkItems as $item)
                                <td>{{ strtoupper($item->modelProduksi->nama ?? $item->model ?? '') ?: '' }}</td>
                                @endforeach
                            </tr>
                            <tr>
                    ...
                    <table class="spec-table" style="margin-bottom:15px;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                @foreach($chunkItems as $item)
                                <td>{{ $item->polaJahitan ? strtoupper($item->polaJahitan->nama) : '' }}</td>
                                @endforeach
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                @foreach($chunkItems as $item)
                                <td>{{ strtoupper($item->resleting->nama ?? '') }}</td>
                                @endforeach
                            </tr>
                        </tbody>
                    </table>
            ...
            @if($isSizeOnly)
                ...
                $rekapGroups = $lampFilled->groupBy(function($ns) use ($hasLampSizeAtasan, $hasLampSizeBawahan) {
                    ...
                    if ($hasLampSizeAtasan) {
                        $sizeName = $ns->size ? $ns->size->ukuran : trim(last(explode('-', $ns->size_label ?? '')));
                    } elseif ($hasLampSizeBawahan) {
                        $sizeName = $ns->sizeCelana ? $ns->sizeCelana->ukuran : trim(last(explode('-', $ns->size_celana_label ?? '')));
                    }
