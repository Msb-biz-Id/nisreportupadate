...
<body>
    ...
    <main>
            ...
            <tr>
                ...
                <td style="width: 40%; padding: 0 0 0 15px; vertical-align: top; text-align: center;">
                    <div style="border: 2px solid #000; padding: 12px 10px; min-height: 110px; background: #fff; text-align: center;">
                        ...
                        <div style="font-size: 11pt; font-weight: 900; color: #000; line-height: 1.2; margin-bottom: 6px; padding-bottom: 4px;">
                            RESELLER:<br>
                        ...
                        @else
                        <div style="font-size: 15pt; font-weight: 900; line-height: 1.2; margin-bottom: 6px; padding-bottom: 4px;">
        ...
        <div style="border:1px solid #000; padding:6px 10px; font-weight:bold; margin-bottom:15px; font-size: 9.5pt;">
            {!! \App\Support\PdfHelper::formatText($raw['catatan']) !!}
        </div>
        @endif
        ...
        <div class="img-wrapper" style="padding:6px; margin-bottom:10px;">
            ...
            <div class="img-box" style="border: 1px solid #000; border-top: none; padding: 6px; margin-bottom: 6px; text-align: center; background: #ffffff;">
                <img src="{{ $dPath }}" style="max-width: 100%; max-height: 540px; display: block; margin: 0 auto;">
            </div>
            @else
